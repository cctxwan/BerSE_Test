...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    protected void drawMarkers(Canvas canvas) {
        ...
        for (int i = 0; i < mIndicesToHighlight.length; i++) {
            ...
            if (set.getLabel().contains("01")){
                // Set the marker to the chart
                mMarker = tempMarks.get(1);
            }else {
                mMarker = tempMarks.get(0);
            }
            ...
            // draw the marker
            mMarker.draw(canvas, pos[0], pos[1]-10);
        }
    }
    ...
    public void setMarkerList(List<IMarker> markers){
        tempMarks = markers;
    }
    ...
    /**
     * paint for the grid background (only line_left and barchart)
     */
