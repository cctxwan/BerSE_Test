...
public abstract class LineScatterCandleRadarDataSet<T extends Entry> extends BarLineScatterCandleBubbleDataSet<T> implements ILineScatterCandleRadarDataSet<T> {
    ...
    /**
     * Sets the width of the highlight line_left in dp.
     * @param width
     */
    ...
    /**
     * Enables the highlight-line_left to be drawn in dashed mode, e.g. like this "- - - - - -"
     *
     * @param lineLength the length of the line_left pieces
     * @param spaceLength the length of space inbetween the line_left-pieces
    ...
    /**
     * Disables the highlight-line_left to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the dashed-line_left effect is enabled for highlight lines, false if not.
     * Default: disabled
     *
     * @return
     */
