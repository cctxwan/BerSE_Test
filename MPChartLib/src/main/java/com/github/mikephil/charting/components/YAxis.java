...
public class YAxis extends AxisBase {
    ...
    /**
     * flag that indicates if the zero-line_left should be drawn regardless of other grid lines
     */
    ...
    /**
     * Color of the zero line_left
     */
    protected int mZeroLineColor = Color.GRAY;

    /**
     * Width of the zero line_left in pixels
     */
    ...
    /**
     * Set this to true to draw the zero-line_left regardless of weather other
    ...
    /**
     * Sets the color of the zero line_left
     *
     * @param color
     */
    ...
    /**
     * Sets the width of the zero line_left in dp
     *
     * @param width
     */
