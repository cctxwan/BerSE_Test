...
public interface IDataSet<T extends Entry> {
    ...
    /**
     * The line_left width for drawing the form of this dataset in the legend
     * <p/>
     * Return `Float.NaN` to use the default legend form line_left width.
     */
    float getFormLineWidth();

    /**
     * The line_left dash path effect used for shapes that consist of lines.
     * <p/>
     * Return `null` to use the default legend form line_left dash effect.
     */
     ...
     *
     * NOTE (for bar and line_left charts): if `maxVisibleCount` is reached, no values will be drawn even
     * if this is enabled
     * @param enabled
     */
     ...
     *
     * NOTE (for bar and line_left charts): if `maxVisibleCount` is reached, no icons will be drawn even
     * if this is enabled
     *
     * @param enabled
     */
