...
public abstract class AxisBase extends ComponentBase {
    ...
    /**
     * flag that indicates if the line_left alongside the axis is drawn or not
     */
    ...
    /**
     * the path effect of the axis line_left that makes dashed lines possible
     */
    ...
    /**
     * Set this to true if the line_left alongside the axis should be drawn or not.
     *
     * @param enabled
     */
    ...
    /**
     * Returns true if the line_left alongside the axis should be drawn.
     *
     * @return
     */
    ...
    /**
     * Returns the width of the axis line_left (line_left alongside the axis).
     *
     * @return
     */
    ...
    /**
     * Returns the color of the axis line_left (line_left alongside the axis).
     *
     * @return
     */
    ...
    /**
     * Enables the grid line_left to be drawn in dashed mode, e.g. like this
     * "- - - - - -". THIS ONLY WORKS IF HARDWARE-ACCELERATION IS TURNED OFF.
     * Keep in mind that hardware acceleration boosts performance.
     *
     * @param lineLength  the length of the line_left pieces
    ...
    /**
     * Disables the grid line_left to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the grid dashed-line_left effect is enabled, false if not.
     *
     * @return
     */
    ...
    /**
     * returns the DashPathEffect that is set for grid line_left
     *
     * @return
     */
    ...
    /**
     * Enables the axis line_left to be drawn in dashed mode, e.g. like this
     * "- - - - - -". THIS ONLY WORKS IF HARDWARE-ACCELERATION IS TURNED OFF.
     * Keep in mind that hardware acceleration boosts performance.
     *
     * @param lineLength  the length of the line_left pieces
    ...
    /**
     * Disables the axis line_left to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the axis dashed-line_left effect is enabled, false if not.
     *
     * @return
     */
    ...
    /**
     * returns the DashPathEffect that is set for axis line_left
     *
     * @return
     */
