...
/**
 * The limit line_left is an additional feature for all Line-, Bar- and
 * ScatterCharts. It allows the displaying of an additional line_left in the chart
...
public class LimitLine extends ComponentBase {
    ...
    /** the width of the limit line_left */
    private float mLineWidth = 2f;

    /** the color of the limit line_left */
    private int mLineColor = Color.rgb(237, 91, 91);

    /** the style of the label text */
    private Paint.Style mTextStyle = Paint.Style.FILL_AND_STROKE;

    /** label string that is drawn next to the limit line_left */
     ...
     *            (xIndex) where this line_left should appear
     */
    ...
    /**
     * Returns the limit that is set for this line_left.
     * 
     * @return
     */
    ...
    /**
     * set the line_left width of the chart (min = 0.2f, max = 12f); default 2f NOTE:
     * thinner line_left == better performance, thicker line_left == worse performance
     * 
     * @param width
     */
    ...
    /**
     * returns the width of limit line_left
     * 
     * @return
     */
    ...
    /**
     * Enables the line_left to be drawn in dashed mode, e.g. like this "- - - - - -"
     * 
    ...
    /**
     * Disables the line_left to be drawn in dashed mode.
     */
    ...
    /**
     * Returns true if the dashed-line_left effect is enabled, false if not. Default:
     * disabled
     * 
     * @return
     */
    ...
    /**
     * Sets the label that is drawn next to the limit line_left. Provide "" if no
     * label is required.
     * 
     * @param label
     */
    ...
    /**
     * Returns the label that is drawn next to the limit line_left.
     * 
     * @return
     */
