...
public interface ILineRadarDataSet<T extends Entry> extends ILineScatterCandleRadarDataSet<T> {
    ...
    /**
     * Returns the color that is used for filling the line_left surface area.
     *
     * @return
     */
    int getFillColor();
    ...
    /**
     * Returns the drawable used for filling the area below the line_left.
     *
     * @return
     */
    ...
    /**
     * Returns the alpha value that is used for filling the line_left surface,
     * default: 85
     *
     * @return
     */
    ...
    /**
     * Returns the stroke-width of the drawn line_left
     *
     * @return
     */
    float getLineWidth();
     ...
     * as a line_left, disabling this will give great performance boost. Please note that this method
