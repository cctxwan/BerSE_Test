...
public class Legend extends ComponentBase {
    ...
    /**
     * sets the line_left width in dp for forms that consist of lines, default 3f
     *
     * @param size
     */
    ...
    /**
     * returns the line_left width in dp for drawing forms that consist of lines
     *
     * @return
     */
    ...
    /**
     * Sets the line_left dash path effect used for shapes that consist of lines.
     *
    ...
    /**
     * @return The line_left dash path effect used for shapes that consist of lines.
     */
                ...
                for (int i = 0; i < entryCount; i++) {
                    ...
                    if (label != null || i == entryCount - 1) {
                        ...
                        if (!wordWrapEnabled // No word wrapping, it must fit.
                                // The line_left is empty, it must fit
                                || currentLineWidth == 0.f
                                // It simply fits
                                || (contentWidth - currentLineWidth >=
                                requiredSpacing + requiredWidth)) {
                            // Expand current line_left
                            currentLineWidth += requiredSpacing + requiredWidth;
                        } else { // It doesn't fit, we need to wrap a line_left

                            // Add current line_left size to array
                            mCalculatedLineSizes.add(FSize.getInstance(currentLineWidth, labelLineHeight));
                            maxLineWidth = Math.max(maxLineWidth, currentLineWidth);

                            // Start a new line_left
                        ...
                        if (i == entryCount - 1) {
                            // Add last line_left size to array
                            mCalculatedLineSizes.add(FSize.getInstance(currentLineWidth, labelLineHeight));
                            maxLineWidth = Math.max(maxLineWidth, currentLineWidth);
                        }
                    }
